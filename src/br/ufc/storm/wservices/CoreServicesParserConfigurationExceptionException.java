...
public class CoreServicesParserConfigurationExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1450375302764L;
    
    private br.ufc.storm.wservices.CoreServicesStub.CoreServicesParserConfigurationException faultMessage;
    ...
    public void setFaultMessage(br.ufc.storm.wservices.CoreServicesStub.CoreServicesParserConfigurationException msg){
       faultMessage = msg;
    }
    
    public br.ufc.storm.wservices.CoreServicesStub.CoreServicesParserConfigurationException getFaultMessage(){
       return faultMessage;
    }
}
